...
<head>
    ...
    <title>Palaeontological Society of India | Monographs</title>
        ...
        <div class="bg-wrapper inner-wrapper">
            ...
            <section class="field-guide-section">
                <div class="container common-container">
                    <h2 class="section-title text-center">Monographs</h2>

                    <div class="field-grid">

                        <!-- Book 1 -->
                        <div class="sha-book">
                            <img src="assets/images/images1/mono2.jpg" alt="Vindhyan Basin">
                        ...
                        <!-- Book 2 -->
                        <div class="sha-book">
                            <img src="assets/images/images1/mono2.jpg" alt="International Field Workshop">
                            <div class="book-content">
                                <h5>Monograph</h5>
                                <p>Part 2</p>
                                <a href="#" class="btn">View Book</a>
                        ...
                        <!-- Book 3 -->
                        <div class="sha-book">
                            <img src="assets/images/images1/mono2.jpg" alt="Lameta & Bagh Beds">
                            <div class="book-content">
                                <h5>Monograph</h5>
                                <p>Part 3</p>
                                <a href="#" class="btn">View Book</a>
